...
<body class="antialiased">
  ...
  <div class="error">
    ...
    <div class="error__subtitle">Oopppss...</div>
    <div class="error__description">Halaman yang Anda cari tidak ditemukan</div>
    <a href="{{route('front-office')}}"><button class="error__button error__button--active">kembali ke beranda</button></a>
