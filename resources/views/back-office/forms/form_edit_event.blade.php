	...
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				...
				<form id="form-input" action="{{ route('event.update', $data->id_event) }}" method="POST" enctype="multipart/form-data">
					@csrf
					@method('PUT') 
						<div class="card-body">
							<div class="row">
								<div class="col-md-12 col-lg-12">
									<div class="form-group">
										...
										<div>
											<input type="text" class="form-control @error('judul_acara') is-invalid @enderror" id="judul_acara" name="judul_acara" placeholder="Acara" value="{{ old('judul_acara', $data->judul_acara) }}">
			                ...
			                @enderror 											
									...
									<div class="form-group">
										...
										<div>
											<input type="text" class="form-control @error('tempat') is-invalid @enderror" id="tempat" name="tempat" placeholder="Tempat" value="{{ old('tempat', $data->tempat) }}">
			                @error('tempat')
			                    <div class="alert alert-danger alert-block small bg-danger">
			                      <strong>{{ $message }}</strong>
			                    </div>
                    ...
                    <div>
                      <div class="mb-3 date-mulai input-group">
                          <input id="tanggal_mulai" type="text" class="form-control input-medium default-date-picker" name="tanggal_mulai" value="{{ old('tanggal_mulai', $data->tanggal_mulai) }}" autocomplete="off" placeholder="Waktu Mulai"  aria-describedby="date-addon2">
                    ...
                    <div>
                      <div class="mb-3 date-selesai input-group">
                          <input id="tanggal_selesai" type="text" class="form-control input-medium default-date-picker" name="tanggal_selesai" value="{{ old('tanggal_selesai', $data->tanggal_akhir) }}" autocomplete="off" placeholder="Waktu Selesai"  aria-describedby="date-addon3">
                          <div class="input-group-append">
			                ...
			                @enderror                                                         
									...
									<div class="form-group">
										...
										<div>
											<textarea class="form-control @error('materi') is-invalid @enderror" id="materi" name="materi" rows="5">{{ old('materi', $data->materi) }}</textarea>
			                @error('materi')
			                    <div class="alert alert-danger alert-block small bg-danger">
			                      <strong>{{ $message }}</strong>
			                    </div>
