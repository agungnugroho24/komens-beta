	...
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				...
				<form id="form-input" action="{{ route('layanan.store') }}" method="POST" enctype="multipart/form-data">
					@csrf
						<div class="card-body">
							<div class="row">
									...
									<div class="form-group">
										...
										<div>
											<select class="form-control @error('kategori') is-invalid @enderror" id="kategori" name="kategori">
												...
												<option value="Pedoman/Panduan Teknis" @if (old('kategori') == "Pedoman/Panduan Teknis") {{ "selected" }} @endif>Pedoman/Panduan Teknis</option>
												<option value="Tips Keamanan Siber" @if (old('kategori') == "Tips Keamanan Siber") {{ "selected" }} @endif>Tips Keamanan Siber</option>
											</select>
			                @error('kategori')
			                    <div class="alert alert-danger alert-block small bg-danger">
			                      <strong>{{ $message }}</strong>
									...
									<div class="form-group">
										...
										<div>
											<div class="input-group">
												...
												<textarea class="form-control @error('logo') is-invalid @enderror" aria-label="With textarea" id="logo" name="logo">{{ old('logo') }}</textarea>
											</div>
			                @error('logo')
			                    <div class="alert alert-danger alert-block small bg-danger">
			                      <strong>{{ $message }}</strong>
