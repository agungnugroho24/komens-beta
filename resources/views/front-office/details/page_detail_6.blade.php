...
@section('content')
  ...
  @endisset
    ...
    <section id="about" class="about" style="padding-bottom:15%;">
      <div class="container">
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-sm-4 grid-margin">
                        <div class="position-relative">
                          <div class="rotate-img">
                            <img src="{{CSIRTHelper::csirt_asset('img/top-bg.png')}}" alt="thumb" class="img-fluid" />
                          </div>
                        </div>
                      </div>
                      <div class="col-sm-8  grid-margin">
                        ...
                        <p class="mb-3 card-text">{!! Str::words($rows->konten, 100, '...') !!}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card-footer border-light">
                    <div class="row">
                      <div class="col-lg-3 col-sm-12">
                        <span><i class="fa fa-calendar"></i> <i class="text-muted" style="font-size:12px;">Published : {{ date("d/M/Y", strtotime($rows->published_at)) }}</i></span>
                      </div>
                      @isset($rows->kategori)
                      <div class="col-lg-3 col-sm-12">
